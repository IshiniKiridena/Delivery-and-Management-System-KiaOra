...
<div class = "wrapper">
        ...
        <div class  = "navigation">
            <ul class="breadcrumb">
                  ...
                  <li><a href="supHome.jsp">SupplierHome</a></li>
                  <li><a href="#">Employee Portal</a></li>
                  <li><a href="#">Admin Account</a></li>
                  <li><a href="#">Oder Details</a></li>
...
<form action="supreport.jsp" method="post" name="oderdetails" onsubmit="return(validateStform());">
